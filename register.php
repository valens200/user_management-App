            ...
            <div class="myform row">
                ...
                <div class="col-8 border border-primary p-5">
                    <div class="text-center">
                        <p class="text-primary fw-bolder mb-5">Register new user</p>
                    </div>
                    ...
                    <div class="mt-3">
                        <p>Already have an accpount ?<span class="text-warning mx-5  fw-bolder"><a href="./index.php">Login</a></span></p>
                    </div>
