       ...
       <div class="container-fluid bg-primary text-white pt-1 pb-1">
           <div class=" container main row">
               ...
               <div class=" text-end col-2">
                   <p class="fw-bolder bg-white text-dark text-center p-2 rounded">About us</p>
               </div>
           </div>
       </div>
</header> 
